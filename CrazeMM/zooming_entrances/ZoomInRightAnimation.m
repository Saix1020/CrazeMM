...
@implementation ZoomInRightAnimation
...
-(void)prepare
{
    ...
    startTransform = CATransform3DConcat(startTransform, CATransform3DMakeTranslation(1000, 0, 0));
    CATransform3D middleTransform = CATransform3DScale(_targetView.layer.transform, .475, .475, .475);
    middleTransform = CATransform3DConcat(middleTransform, CATransform3DMakeTranslation(-10, 0, 0));
