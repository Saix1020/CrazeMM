...
{
    self =[self initWithFrame:frame overlayMode:TTModalOverlayModeLinear];
    if(self){
...
- (instancetype)initWithFrame:(CGRect)frame overlayMode:(TTModalOverlayMode)overlayMode {
