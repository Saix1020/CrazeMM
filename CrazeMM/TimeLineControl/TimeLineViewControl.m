...
@synthesize timeLabelsHeight = timeLabelsHeight;
@synthesize descLabelsHeight = descLabelsHeight;
...
- (void)addTimeLabels:(NSArray *)time currentStatus:(int)currentStatus {
    ...
    for (NSString *timeDescription in time) {
        ...
        label.textColor = i < currentStatus ? [UIColor UIColorFromRGB:0x0c9145] : [UIColor grayColor];
        ...
        [label makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.equalTo(descrLabel.masx_top);//.with.offset(betweenLabelOffset + 1);
        }];
    ...
    descLabelsHeight = viewheight-BETTWEEN_LABEL_OFFSET;
