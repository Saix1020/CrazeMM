...
-(void)setLightText:(BOOL)light {
    if(light) {
        ...
        self.hasItemsIndicator.image = [UIImage imageNamed:@"calendar_littledot-disabled" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil]; //: [UIImage imageNamed:@"calendar_littledot-disabled"]);
    } else {
        UIColor * color = [UIColor colorWithWhite:.3 alpha:1];
        [self.dateButton setTitleColor:color forState:UIControlStateNormal];
        self.hasItemsIndicator.image =  [UIImage imageNamed:@"calendar_littledot" inBundle:[NSBundle bundleForClass:self.class] compatibleWithTraitCollection:nil]; // : [UIImage imageNamed:@"calendar_littledot"]);
    }
