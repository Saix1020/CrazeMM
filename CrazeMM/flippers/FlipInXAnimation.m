...
@implementation FlipInXAnimation
...
-(void)prepare
{
    ...
    NSArray * values = @[
                         [NSValue valueWithCATransform3D: CATransform3DConcat(CATransform3DPerspective(originTransform,400), CATransform3DRotate(originTransform, deg(90), 1, 0, 0))
                          ],
                         [NSValue valueWithCATransform3D:CATransform3DRotate(CATransform3DPerspective(originTransform,400), deg(-20), 1, 0, 0)
                          ],
                         [NSValue valueWithCATransform3D:CATransform3DRotate(CATransform3DPerspective(originTransform,400), deg(10), 1, 0, 0)
                          ],
                         [NSValue valueWithCATransform3D:CATransform3DRotate(CATransform3DPerspective(originTransform,400), deg(-5), 1, 0, 0)
                          ],
